...
!(function (t, e) {
  ...
  function vt(t) {
    ...
    return i && ('html' === nt(i) || ('body' === nt(i) && 'static' === pt(i).position))
      ...
      : i ||
          (function (t) {
            for (
              var e = -1 !== navigator.userAgent.toLowerCase().indexOf('firefox'), i = _t(t);
      ...
      : Ut(
          (function (t) {
            var e,
              ...
              l = -s.scrollTop;
            return (
              'rtl' === pt(n || i).direction && (a += wt(i.clientWidth, n ? n.clientWidth : 0) - o),
  ...
  function te(t, e, i) {
    ...
    return (
      (a || (!a && !i)) &&
        (('body' !== nt(e) || Ht(o)) &&
          (l = (s = e) !== ot(s) && at(s) ? { scrollLeft: (n = s).scrollLeft, scrollTop: n.scrollTop } : Rt(s)),
  ...
  class _e extends j {
    ...
    static dataApiKeydownHandler(t) {
      ...
      if ('Escape' === t.key)
        return (
          (this.matches('[data-bs-toggle="dropdown"]') ? this : H.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(),
          void _e.clearMenus()
        );
      if (!i && ('ArrowUp' === t.key || 'ArrowDown' === t.key))
        return void (
          this.matches('[data-bs-toggle="dropdown"]') ? this : H.prev(this, '[data-bs-toggle="dropdown"]')[0]
        ).click();
          ...
          N.on(this._element, 'click.dismiss.bs.modal', (t) => {
            this._ignoreBackdropClick
              ...
              : t.target === t.currentTarget &&
                ('static' === this._config.backdrop ? this._triggerBackdropTransition() : this.hide());
          }),
          e && u(this._backdrop),
  ...
  class Oe extends j {
    ...
    _getConfig(t) {
      return (
        (t = { ...Ae, ...B.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }),
        l('offcanvas', t, Le),
        t
      );
    }
    ...
    setElementContent(t, e) {
      if (null !== t)
        return 'object' == typeof e && r(e)
          ...
          : void (this.config.html
              ? (this.config.sanitize && (e = Se(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
      let t = this._element.getAttribute('data-bs-original-title');
      return (
        t || (t = 'function' == typeof this.config.title ? this.config.title.call(this._element) : this.config.title), t
      );
    }
    updateAttachment(t) {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if (
          ...
          (e || ((e = new Fe(this, i)), b.set(this, 'bs.popover', e)), 'string' == typeof t)
        ) {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
    ...
    _transitionComplete(t, e, i) {
      ...
      t.classList.add('active'),
        ...
        t.parentNode &&
          ...
          (t.closest('.dropdown') && H.find('.dropdown-toggle').forEach((t) => t.classList.add('active')),
  ...
  class Qe extends j {
    ...
    _getConfig(t) {
      return (
        (t = { ...Xe, ...B.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) }),

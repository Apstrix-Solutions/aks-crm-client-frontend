          ...
          fix: {
            console: function () {
              s.debug('Normalizing window.console'),
                ...
                (void 0 !== console.group && void 0 !== console.groupEnd && void 0 !== console.groupCollapsed) ||
          ...
          performance: {
            log: function (e) {
              ...
              u.performance &&
                ...
                (i = t),
                o.push({ Element: m, Name: e[0], Arguments: [].slice.call(e, 1) || '', 'Execution Time': n })),
    ...
    (e =
            ...
            (h = {
              ...
              reset: function () {
                n.each(function () {
                  ...
                  o !== D &&
                    (s && (h.verbose('Resetting error on field', n), n.removeClass(m.error), i.remove()),
                    r
                      ? (h.verbose('Resetting dropdown value', t, o), t.dropdown('restore defaults'))
                      : a
                ...
                settings: function () {
                  if (F.isPlainObject(x)) {
                    ...
                    0 < e.length && x[e[0]].identifier !== D && x[e[0]].rules !== D
                      ...
                      : (x.fields && h.is.shorthandFields(x.fields) && (x.fields = h.get.fieldsFromShorthand(x.fields)),
                  ...
                  (t = 'string' == typeof t ? [t] : t),
                    ...
                    d.inline &&
                      ...
                      o
                        ...
                        : (h.verbose('Displaying error with fallback javascript animation'), i.fadeIn(d.duration)));
                },
                errors: function (e) {
                    ...
                    F.each(e, function (e, t) {
                      ...
                      0 < i.length &&
                        (a && r
                          ...
                          : s
                          ? (h.verbose('Setting dropdown value', t, o), o.dropdown('set selected', t))
              ...
              validate: {
                ...
                field: function (n, e, t) {
                  ...
                  var i = n.identifier || e,
                    ...
                    s = [];
                  return (
                    n.identifier || (h.debug('Using field name as identifier', i), (n.identifier = i)),
                    o.prop('disabled')
                      ...
                      ? (h.debug('Field depends on another value that is not present or empty. Skipping', a), (r = !0))
                      : n.rules !== D &&
                        F.each(n.rules, function (e, t) {
                          h.has.field(i) &&
                            !h.validate.rule(n, t) &&
                            (h.debug('Field is invalid', i, t.type), s.push(h.get.prompt(t, n)), (r = !1));
                        }),
                    r
              ...
              debug: function () {
                !d.silent &&
                  ...
                  (d.performance
                    ...
                    : ((h.debug = Function.prototype.bind.call(console.info, console, d.name + ':')),
              ...
              verbose: function () {
                !d.silent &&
                  ...
                  (d.performance
                    ? h.performance.log(arguments)
                    : ((h.verbose = Function.prototype.bind.call(console.info, console, d.name + ':')),
              ...
              performance: {
                log: function (e) {
                  ...
                  d.performance &&
                    ...
                    (k = t),
                    T.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: v, 'Execution Time': n })),
      ...
      (F.fn.form.settings = {
        ...
        rules: {
          ...
          integer: function (e, t) {
            ...
            return (
              t &&
                ...
                (-1 == t.indexOf('..')
                  ? a.test(t) && (n = i = t - 0)
                  : ((o = t.split('..', 2)), a.test(o[0]) && (n = o[0] - 0), a.test(o[1]) && (i = o[1] - 0))),
          ...
          is: function (e, t) {
            return (
              (t = 'string' == typeof t ? t.toLowerCase() : t), (e = 'string' == typeof e ? e.toLowerCase() : e) == t
            );
          },
              ...
              if (
                ...
                s &&
                  (F.each(s, function (e, t) {
                    (i = o[t]) &&
                      (a = { length: -1 !== F.inArray(n.length, i.length), pattern: -1 !== n.search(i.pattern) })
                        .length &&
                      a.pattern &&
                      (r = !0);
                  }),
            ...
            (c = {
                  ...
                  : (c.debug('Opening accordion content', t),
                    ...
                    u.animateChildren &&
                      (S.fn.transition !== T && m.transition('is supported')
                        ...
                        : n.children().stop(!0, !0).animate({ opacity: 1 }, u.duration, c.resetOpacity)),
                ...
                (!o && !(!o && i)) ||
                  ...
                  u.animateChildren &&
                    (S.fn.transition !== T && m.transition('is supported')
                      ...
                      : n.children().stop(!0, !0).animate({ opacity: 0 }, u.duration, c.resetOpacity)),
              ...
              closeOthers: function (e) {
                ...
                (i = u.closeNested
                  ...
                  : ((t = r.find(s).not(a)), (n = r.find(l).find(s).not(a)), (t = t.not(n)).next(p))),
                  0 < t.length &&
                    ...
                    u.animateChildren &&
                      (S.fn.transition !== T && m.transition('is supported')
                        ...
                        : i.children().stop(!0, !0).animate({ opacity: 0 }, u.duration, c.resetOpacity)),
              ...
              debug: function () {
                !u.silent &&
                  ...
                  (u.performance
                    ...
                    : ((c.debug = Function.prototype.bind.call(console.info, console, u.name + ':')),
              ...
              verbose: function () {
                !u.silent &&
                  ...
                  (u.performance
                    ? c.performance.log(arguments)
                    : ((c.verbose = Function.prototype.bind.call(console.info, console, u.name + ':')),
              ...
              performance: {
                log: function (e) {
                  ...
                  u.performance &&
                    ...
                    (b = t),
                    y.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: l, 'Execution Time': n })),
            ...
            (s = {
              ...
              enable: function () {
                s.is.enabled()
                  ...
                  : (s.debug('Enabling checkbox'), s.set.enabled(), i.onEnable.call(f), i.onEnabled.call(f));
              },
              disable: function () {
                s.is.disabled()
                  ? s.debug('Checkbox is already disabled')
                  : (s.debug('Disabling checkbox'), s.set.disabled(), i.onDisable.call(f), i.onDisabled.call(f));
              },
              get: {
                radios: function () {
                  var e = s.get.name();
              ...
              should: {
                ...
                allowIndeterminate: function () {
                  return s.is.indeterminate() && !s.should.forceCallbacks()
                    ? (s.debug('Should not allow indeterminate, checkbox is already indeterminate'), !1)
                    : !1 !== i.beforeIndeterminate.apply(f) ||
                        (s.debug('Should not allow indeterminate, beforeIndeterminate cancelled'), !1);
                },
                ...
                indeterminate: function () {
                  s.verbose('Setting class to indeterminate'),
                    ...
                    s.is.indeterminate()
                      ...
                      : (s.debug('Setting state to indeterminate'), d.prop('indeterminate', !0), s.trigger.change());
                },
                determinate: function () {
                ...
                disabled: function () {
                  s.verbose('Setting class to disabled'),
                    ...
                    s.is.disabled()
                      ...
                      : (s.debug('Setting state to disabled'), d.prop('disabled', 'disabled'), s.trigger.change());
                },
                enabled: function () {
                  s.verbose('Removing disabled class'),
                    ...
                    s.is.enabled()
                      ...
                      : (s.debug('Setting state to enabled'), d.prop('disabled', !1), s.trigger.change());
                },
                tabbable: function () {
              ...
              create: {
                label: function () {
                  0 < d.prevAll(o.label).length
                    ? (d.prev(o.label).detach().insertAfter(d), s.debug('Moving existing label', u))
                    : s.has.label() || ((u = T('<label>').insertAfter(d)), s.debug('Creating label', u));
                },
              },
              has: {
                label: function () {
              ...
              toggle: function () {
                s.can.change()
                  ? s.is.indeterminate() || s.is.unchecked()
                    ...
                    : s.is.checked() && s.can.uncheck() && (s.debug('Currently checked'), s.uncheck())
              ...
              verbose: function () {
                !i.silent &&
                  ...
                  (i.performance
                    ? s.performance.log(arguments)
                    : ((s.verbose = Function.prototype.bind.call(console.info, console, i.name + ':')),
                      s.verbose.apply(console, arguments)));
              },
              error: function () {
                i.silent ||
              ...
              performance: {
                log: function (e) {
                  ...
                  i.performance &&
                    ...
                    (x = t),
                    C.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: h, 'Execution Time': n })),
                    clearTimeout(s.performance.timer),
                    (s.performance.timer = setTimeout(s.performance.display, 500));
                },
                display: function () {
          ...
          v.each(function () {
            ...
            (s = {
              ...
              bind: {
                events: function () {
                  'hover' == r.on
                    ...
                    s.is.closable() &&
                      (s.verbose('Adding dimmer close event', a), t.on(d + o, n.dimmer, s.event.click));
                },
              },
              unbind: {
                events: function () {
              ...
              create: function () {
                ...
                return (
                  r.dimmerName && (s.debug('Creating named dimmer', r.dimmerName), e.addClass(r.dimmerName)),
                  e.appendTo(t),
                  e
                );
              },
              ...
              hide: function (e) {
                (e = S.isFunction(e) ? e : function () {}),
                  s.is.dimmed() || s.is.animating()
                    ? (s.debug('Hiding dimmer', a), s.animate.hide(e), r.onHide.call(m), r.onChange.call(m))
              ...
              debug: function () {
                !r.silent &&
                  ...
                  (r.performance
                    ? s.performance.log(arguments)
                    : ((s.debug = Function.prototype.bind.call(console.info, console, r.name + ':')),
                      s.debug.apply(console, arguments)));
              },
              verbose: function () {
                !r.silent &&
                  ...
                  (r.performance
                    ? s.performance.log(arguments)
                    : ((s.verbose = Function.prototype.bind.call(console.info, console, r.name + ':')),
                      s.verbose.apply(console, arguments)));
              },
              error: function () {
                r.silent ||
              ...
              performance: {
                log: function (e) {
                  ...
                  r.performance &&
                    ((n = (t = new Date().getTime()) - (b || t)),
                    (b = t),
                    y.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: m, 'Execution Time': n })),
                    clearTimeout(s.performance.timer),
                    (s.performance.timer = setTimeout(s.performance.display, 500));
                },
                display: function () {
            ...
            (g = {
                ...
                layout: function () {
                  w.is('select') && (g.setup.select(), g.setup.returnedObject()),
                    ...
                    g.is.search() &&
                      ...
                      (T = Y('<input />').addClass(h.search).prop('autocomplete', 'off').insertBefore(k))),
                  ...
                  g.debug('Dropdown initialized on a select', e),
                    ...
                    0 < R.parent(y.dropdown).length
                      ...
                      : (g.debug('Creating entire dropdown from select'),
                        ...
                        R.prop('disabled') && (g.debug('Disabling dropdown'), w.addClass(h.disabled)),
              ...
              show: function (e) {
                if (
                  ...
                  !g.can.show() &&
                    g.is.remote() &&
                    (g.debug('No API results retrieved, searching before show'), g.queryRemote(g.get.query(), g.show)),
                  g.can.show() && !g.is.active())
                ) {
                  if (
                    (g.debug('Showing dropdown'),
                    !g.has.message() || g.has.maxSelections() || g.has.allResultsFiltered() || g.remove.message(),
                    g.is.allFiltered())
                  )
                    return !0;
                  !1 !== p.onShow.call(z) &&
              ...
              bind: {
                ...
                mouseEvents: function () {
                  g.verbose('Binding mouse events'),
                    g.is.multiple() &&
                      w.on('click' + x, y.label, g.event.label.click).on('click' + x, y.remove, g.event.remove.click),
                        ...
                        ? p.onNoResults.call(z, t)
                          ? p.allowAdditions
                            ? p.hideAdditions &&
                              ...
                              g.set.empty(),
                              g.hideMenu())
                            : (g.verbose('All items filtered, showing message', t), g.add.message(c.noResults))
              ...
              focusSearch: function (e) {
                g.has.search() &&
                  ...
                  (e
                    ? (w.off('focus' + x, y.search), T.focus(), w.on('focus' + x, y.search, g.event.search.focus))
                    : T.focus());
              },
              forceSelection: function () {
                ...
                if (0 < n.length && !g.is.multiple())
                  return (
                    g.debug('Forcing partial selection to selected item', n), void g.event.item.click.call(n, {}, !0)
                  );
                      ...
                      t == v.leftArrow
                        ? (!f && !m) || r
                          ? r &&
                            ...
                            l && !s ? i.addClass(h.active) : i.prev(y.siblingLabel).addClass(h.active).end(),
                            e.preventDefault())
                  ...
                  if (g.is.inObject(t, v)) {
                    ...
                    if (
                      ...
                      if (
                        ((t == v.enter || m) &&
                          (t == v.enter && d && u && !p.allowCategorySelection
                            ? (g.verbose('Pressed enter on unselectable category, opening sub menu'),
                              (t = v.rightArrow))
                            : f &&
                              (g.verbose('Selecting item from keyboard shortcut', a),
                              g.event.item.click.call(a, e),
                        ...
                        if (
                          ((n = d && c ? a.prevAll(y.item + ':not(' + y.unselectable + ')').eq(0) : O.eq(0)),
                          r.index(n) < 0)
                        )
                      ...
                      if (t == v.downArrow) {
                        if (
                          0 ===
                          (n = d && c ? (n = a.nextAll(y.item + ':not(' + y.unselectable + ')').eq(0)) : O.eq(0)).length
                        )
                          return (
                            g.verbose('Down key pressed but reached bottom of current menu'), void e.preventDefault()
                          );
                      ...
                      m && e.preventDefault(),
                        t != v.downArrow ||
                          g.is.visible() ||
                          (g.verbose('Down key pressed, showing dropdown'), g.show(), e.preventDefault());
                ...
                selectAction: function (e, t) {
                  g.verbose('Determining action', p.action),
                    Y.isFunction(g.action[p.action])
                      ? (g.verbose('Triggering preset action', p.action, e, t), g.action[p.action].call(z, e, t, this))
                      : Y.isFunction(p.action)
                      ? (g.verbose('Triggering user action', p.action, e, t), p.action.call(z, e, t, this))
              ...
              get: {
                ...
                choiceText: function (e, t) {
                  if (((t = t !== J ? t : p.preserveHTML), e))
                    return (
                      ...
                      e.data(b.text) !== J ? e.data(b.text) : t ? Y.trim(e.html()) : Y.trim(e.text())
                    );
                },
                ...
                selectValues: function () {
                  ...
                  return (
                    ...
                    p.placeholder &&
                      'auto' !== p.placeholder &&
                      (g.debug('Setting placeholder value to', p.placeholder), (o.placeholder = p.placeholder)),
                    p.sortSelect
                      ...
                      O.each(function () {
                        ...
                        if (null !== n && n !== J)
                          if (a) (-1 === Y.inArray(String(n), i) && -1 === Y.inArray(t, i)) || (r = r ? r.add(e) : e);
                            ...
                            if (
                              (g.verbose('Ambiguous dropdown value using strict type check', e, i), n === i || t === i)
                            )
                              return (r = e), !0;
              ...
              restore: {
                ...
                defaultValue: function () {
                  ...
                  e !== J &&
                    ...
                    '' !== e ? (g.set.value(e), g.set.selected()) : (g.remove.activeItem(), g.remove.selectedItem()));
                },
                labels: function () {
                  p.allowAdditions &&
                ...
                selected: function () {
                  g.restore.values(),
                    g.is.multiple()
                      ? (g.debug('Restoring previously selected values and labels'), g.restore.labels())
              ...
              save: {
                ...
                placeholderText: function () {
                  ...
                  !1 !== p.placeholder &&
                    ...
                    ((e = g.get.text()), g.verbose('Saving placeholder text as', e), w.data(b.placeholderText, e));
                },
                remoteData: function (e, t) {
                  Z.Storage !== J
                    ? (g.verbose('Saving remote data to session storage', t, e), sessionStorage.setItem(t, e))
                    : g.error(f.noStorage);
                },
              },
              clear: function () {
              ...
              set: {
                filtered: function () {
                  ...
                  e && o && (g.verbose('Adjusting input width', a, p.glyphWidth), T.css('width', a)),
                    o || (n && r)
                      ...
                      : (!e || (n && !r)) && (g.verbose('Showing placeholder text'), k.removeClass(h.filtered));
                },
                empty: function () {
                  w.addClass(h.empty);
                },
                ...
                text: function (e) {
                  'select' !== p.action &&
                    ('combo' == p.action
                      ? (g.debug('Changing combo button text', e, E), p.preserveHTML ? E.html(e) : E.text(e))
                ...
                value: function (e, t, n) {
                  ...
                  if (o) {
                    if (
                      !p.allowReselection &&
                      r == a &&
                      (g.verbose('Skipping value update already same value', e, a), !g.is.initialLoad())
                    )
                      return;
                    g.is.single() &&
                      g.has.selectInput() &&
                        ...
                        ? !o || a
                          ? (p.apiSettings && p.saveRemoteData && g.save.remoteData(t, n),
                            p.useLabels
                              ...
                              : (g.add.value(n, t, e), g.set.text(g.add.variables(c.count)), g.set.activeItem(e)))
                          : i || (g.debug('Selected active value, removing label'), g.remove.selected(n))
                        : (p.apiSettings && p.saveRemoteData && g.save.remoteData(t, n),
                          g.set.text(t),
                          g.set.value(n, t, e),
              ...
              add: {
                      ...
                      : (p.label.variation && i.addClass(p.label.variation),
                        !0 === n
                          ? (g.debug('Animating in label', i),
                            i.addClass(h.hidden).insertBefore(o).transition(p.label.transition, p.label.duration))
                ...
                optionValue: function (e) {
                  ...
                  0 < R.find('option[value="' + g.escape.string(t) + '"]').length ||
                    (g.disconnect.selectObserver(),
                    g.is.single() &&
                      (g.verbose('Removing previous user addition'), R.find('option.' + h.addition).remove()),
                    Y('<option/>').prop('value', t).addClass(h.addition).html(e).appendTo(R),
                    ...
                    ('' === e || o
                      ...
                      : (a
                          ? (n
                            ...
                            p.hideAdditions || ((t = p.templates.addition(g.add.variables(c.addResult, e))), n.html(t)),
                            g.verbose('Replacing user suggestion with new value', n))
                          : ((n = g.create.userChoice(e)).prependTo(F),
                            g.verbose('Adding item choice to menu corresponding with user choice addition', n)),
                ...
                variables: function (e, t) {
                  ...
                  return (
                    ...
                    a && ((n = g.get.selectionCount()), (e = e.replace('{maxCount}', p.maxSelections))),
                ...
                value: function (e, t, n) {
                  ...
                  g.has.value(e)
                    ...
                    ? ((i = Y.isArray(o) ? ((i = o.concat([e])), g.get.uniqueArray(i)) : [e]),
                      g.has.selectInput()
                        ? g.can.extendSelect() && (g.debug('Adding value to select', e, i, R), g.add.optionValue(e))
                        : ((i = i.join(p.delimiter)), g.debug('Setting hidden input to delimited value', i, R)),
                      !1 === p.fireOnInit && g.is.initialLoad()
              ...
              remove: {
                ...
                optionValue: function (e) {
                  ...
                  0 < n.length &&
                    ...
                    (r && (r.disconnect(), g.verbose('Temporarily disconnecting mutation observer')),
                    n.remove(),
                    ...
                    g.is.multiple()
                      ? p.useLabels
                        ...
                        : (g.remove.value(n, t, e),
                          0 === g.get.selectionCount() ? g.set.placeholderText() : g.set.text(g.add.variables(c.count)))
                      : g.remove.value(n, t, e),
                  ...
                  (e = e || w.find(y.label)),
                    ...
                    e.each(function () {
                      ...
                      !1 !== p.onLabelRemove.call(e, t)
                        ? (g.remove.message(), i ? (g.remove.value(n), g.remove.label(n)) : g.remove.selected(n))
              ...
              has: {
                ...
                minCharacters: function (e) {
                  return (
                    !p.minCharacters || (e = e !== J ? String(e) : String(g.get.query())).length >= p.minCharacters
                  );
                },
                firstLetter: function (e, t) {
                  ...
                  return (
                    ...
                    ((n = g.get.choiceText(e, !1)), (t = t.toLowerCase()) == String(n).charAt(0).toLowerCase())
                  );
                },
                input: function () {
                  return 0 < R.length;
              ...
              can: {
                ...
                openDownward: function (e) {
                  ...
                  return (
                    ...
                    g.is.verticallyScrollableContext() && (n.menu.offset.top += n.context.scrollTop),
                    (o = (t = {
                      ...
                      : (g.verbose('Dropdown cannot fit in either direction, favoring downward', t), !0)),
                ...
                openRightward: function (e) {
                  ...
                  return (
                    ...
                    g.is.horizontallyScrollableContext() && (n.menu.offset.left += n.context.scrollLeft),
                    (t =
              ...
              debug: function () {
                !p.silent &&
                  ...
                  (p.performance
                    ...
                    : ((g.debug = Function.prototype.bind.call(console.info, console, p.name + ':')),
              ...
              verbose: function () {
                !p.silent &&
                  ...
                  (p.performance
                    ? g.performance.log(arguments)
                    : ((g.verbose = Function.prototype.bind.call(console.info, console, p.name + ':')),
              ...
              performance: {
                log: function (e) {
                  ...
                  p.performance &&
                    ...
                    (W = t),
                    B.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: z, 'Execution Time': n })),
              ...
              bind: {
                events: function () {
                  s.has.placeholder() &&
                    ...
                    d.on('click' + c, e.placeholder, s.createAndShow).on('click' + c, e.icon, s.createAndShow));
                },
              },
              create: function () {
              ...
              generate: {
                embed: function (e) {
                  ...
                  var t,
                    ...
                    i = s.get.source();
                  return (
                    (e = s.get.url(e)) ? ((n = s.generate.parameters(i)), (t = r.iframe(e, n))) : s.error(l.noURL, d), t
                  );
                },
                parameters: function (e, t) {
                  var n = o[e] && o[e].parameters !== A ? o[e].parameters(i) : {};
                  return (
                    (t = t || i.parameters) && (n = k.extend({}, n, t)), (n = i.onEmbed(n)), s.encode.parameters(n)
                  );
                },
              },
              has: {
              ...
              performance: {
                log: function (e) {
                  ...
                  i.performance &&
                    ...
                    (y = t),
                    x.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: m, 'Execution Time': n })),
                    clearTimeout(s.performance.timer),
                    (s.performance.timer = setTimeout(s.performance.display, 500));
                },
                display: function () {
      ...
      (k.fn.embed.settings = {
        ...
        templates: {
          ...
          placeholder: function (e, t) {
            var n = '';
            return (
              t && (n += '<i class="' + t + ' icon"></i>'), e && (n += '<img class="placeholder" src="' + e + '">'), n
            );
          },
        },
        api: !1,
            ...
            (l = {
                ...
                dimmer: function () {
                  ...
                  j.fn.dimmer !== M
                    ? (l.debug('Creating dimmer'),
                      (o = v.dimmer(t)),
                      c.detachable
                        ? (l.verbose('Modal is detachable, moving content into dimmer'), o.dimmer('add content', h))
                        : l.set.undetached(),
              ...
              attachEvents: function (e, t) {
                ...
                (t = j.isFunction(l[t]) ? l[t] : l.toggle),
                  0 < n.length
                    ? (l.debug('Attaching modal events to element', e, t), n.off(g).on('click' + g, t))
                ...
                (e = j.isFunction(e) ? e : function () {}),
                  l.is.animating() || !l.is.active()
                    ? (l.showDimmer(),
                      ...
                      l.can.useFlex()
                        ? l.remove.legacy()
                        : (l.set.legacy(), l.set.modalOffset(), l.debug('Using non-flex legacy modal positioning.')),
                      l.set.screenHeight(),
                      l.set.type(),
                      l.set.clickaway(),
              ...
              set: {
                ...
                type: function () {
                  l.can.fit()
                    ...
                    : (l.verbose('Modal cannot fit on screen setting to scrolling'), l.set.scrolling());
                },
                undetached: function () {
              ...
              verbose: function () {
                !c.silent &&
                  ...
                  (c.performance
                    ? l.performance.log(arguments)
                    : ((l.verbose = Function.prototype.bind.call(console.info, console, c.name + ':')),
              ...
              performance: {
                log: function (e) {
                  ...
                  c.performance &&
                    ...
                    (P = t),
                    E.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: y, 'Execution Time': n })),
            ...
            (s = {
              ...
              show: function () {
                s.should.show() &&
                  ...
                  'fade' == i.animation.show ? a.fadeIn(i.duration, i.easing) : a.slideDown(i.duration, i.easing));
              },
              hide: function () {
              ...
              storage: {
                set: function (e, t) {
                  ...
                  if ('localstorage' == i.storageMethod && x.localStorage !== C)
                    ...
                    x.sessionStorage.setItem(e, t), s.debug('Value stored using session storage', e, t);
                  else {
              ...
              performance: {
                log: function (e) {
                  ...
                  i.performance &&
                    ...
                    (g = t),
                    p.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: c, 'Execution Time': n })),
                    clearTimeout(s.performance.timer),
                    (s.performance.timer = setTimeout(s.performance.display, 500));
                },
                display: function () {
            ...
            (d = {
              ...
              observeChanges: function () {
                'MutationObserver' in I &&
                  ((e = new MutationObserver(d.event.documentChanged)).observe(M, { childList: !0, subtree: !0 }),
                  ...
                  f.popup
                    ? (u.addClass(m.loading),
                      ...
                      f.movePopup &&
                        ...
                        (d.debug('Moving popup to the same offset parent as target'), u.detach().appendTo(c)))
                    : (c = f.inline ? d.get.offsetParent(b) : d.has.popup() ? d.get.offsetParent(u) : P),
              ...
              create: function () {
                ...
                e || n || t
                  ? (d.debug('Creating pop-up html'),
                    ...
                    (u = z('<div/>').addClass(m.popup).data(p.activator, h).html(e)),
                    f.inline
              ...
              restore: {
                conditions: function () {
                  return (
                    d.cache &&
                      d.cache.title &&
                      (h.attr('title', d.cache.title), d.verbose('Restoring original attributes', d.cache.title)),
                    !0
                  );
                },
              },
              ...
              get: {
                ...
                calculations: function () {
                  ...
                  return (
                    f.setFluidWidth &&
                      d.is.fluid() &&
                      ((r.container = { width: u.parent().outerWidth() }), (r.popup.width = r.container.width)),
                ...
                offsetParent: function (e) {
                  ...
                  if (t)
                    for (
                      var i = 'none' === n.css('transform'), o = 'static' === n.css('position'), a = n.is('body');
                      t && !a && o && i;
                ...
                nextPosition: function (e) {
                  ...
                  return (
                    ...
                    (x[e] = !0),
                    'opposite' === f.prefer &&
                      ((s = (s = [{ top: 'bottom', bottom: 'top', left: 'right', right: 'left' }[n], i]).join(' ')),
                      (a = !0 === x[s]),
                  ...
                  if (0 !== b.length && 0 !== u.length) {
                    ...
                    if (
                      ...
                      d.should.centerArrow(t) &&
                        ...
                        ('top left' != e && 'bottom left' != e) || ((n += o.width / 2), (n -= f.arrowPixelsFromEdge)),
                    ...
                    switch (
                      ...
                      y == f.maxSearchDepth && 'string' == typeof f.lastResort && (e = f.lastResort),
                      e)
                    ) {
                      case 'top left':
                    ...
                    if (
                      ...
                      u.css(s).removeClass(m.position).addClass(e).addClass(m.loading),
                      (l = d.get.popupOffset()),
              ...
              bind: {
                events: function () {
                  d.debug('Binding popup events to module'),
                    ...
                    d.get.startEvent() &&
                      h.on(d.get.startEvent() + a, d.event.start).on(d.get.endEvent() + a, d.event.end),
              ...
              debug: function () {
                !f.silent &&
                  ...
                  (f.performance
                    ...
                    : ((d.debug = Function.prototype.bind.call(console.info, console, f.name + ':')),
              ...
              verbose: function () {
                !f.silent &&
                  ...
                  (f.performance
                    ? d.performance.log(arguments)
                    : ((d.verbose = Function.prototype.bind.call(console.info, console, f.name + ':')),
              ...
              performance: {
                log: function (e) {
                  ...
                  f.performance &&
                    ...
                    (F = t),
                    O.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: w, 'Execution Time': n })),
          ...
          popup: function (e) {
            ...
            return (
              typeof e !== L &&
                ...
                typeof e.content !== L &&
                  e.content &&
                  ((e.content = n(e.content)), (t += '<div class="content">' + e.content + '</div>'))),
              t
            );
          },
        },
            ...
            read: {
              ...
              settings: function () {
                !1 !== i.total && (s.debug('Current total set in settings', i.total), s.set.total(i.total)),
                  !1 !== i.value &&
                    (s.debug('Current value set in settings', i.value), s.set.value(i.value), s.set.progress(s.value)),
            ...
            set: {
              ...
              state: function (e) {
                100 === (e = e !== A ? e : s.percent)
                  ? i.autoSuccess && !(s.is.warning() || s.is.error() || s.is.success())
                    ...
                    : (s.verbose('Reached 100% removing active state'), s.remove.active(), s.remove.progressPoll())
                  : 0 < e
              ...
              barLabel: function (e) {
                e !== A
                  ...
                  : 'percent' == i.label &&
                    (s.verbose('Adding percentage to bar label'), d.text(s.get.text(i.text.percent)));
              },
              active: function (e) {
                (e = e || i.text.active),
              ...
              progress: function (e) {
                s.has.progressPoll()
                  ? (s.debug('Updated within interval, setting next update to use new value', e), s.set.nextValue(e))
            ...
            update: {
              ...
              progress: function (e) {
                ...
                !1 === (e = s.get.numericValue(e)) && s.error(l.nonNumeric, e),
                  ...
                  s.has.total()
                    ? (s.set.value(e), (t = (e / s.total) * 100), s.debug('Calculating percent complete from total', t))
            ...
            (i = {
              ...
              debug: function () {
                !o.silent &&
                  ...
                  (o.performance
                    ...
                    : ((i.debug = Function.prototype.bind.call(console.info, console, o.name + ':')),
              ...
              verbose: function () {
                !o.silent &&
                  ...
                  (o.performance
                    ? i.performance.log(arguments)
                    : ((i.verbose = Function.prototype.bind.call(console.info, console, o.name + ':')),
              ...
              performance: {
                log: function (e) {
                  ...
                  o.performance &&
                    ...
                    (v = t),
                    b.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: c, 'Execution Time': n })),
            ...
            (f = {
              ...
              bind: {
                events: function () {
                  f.verbose('Binding events to search'),
                    c.automatic &&
                      (h.on(f.get.inputEvent() + i, g.prompt, f.event.input), v.attr('autocomplete', 'off')),
                    h
              ...
              handleKeyboard: function (e) {
                var t,
                  ...
                  d = 40;
                if (
                  (l == 27 && (f.verbose('Escape key pressed, blurring search field'), f.hideResults(), (x = !0)),
                  f.is.visible())
                )
                  if (l == c) {
                ...
                result: function (n, e) {
                  ...
                  return (
                    ...
                    'category' === c.type
                      ...
                      : (f.debug('Finding result in results object', n), (o = f.search.object(n, e, i)[0])),
                    o || !1
                  );
                },
              },
              ...
              clear: {
                cache: function (e) {
                  ...
                  e
                    ? e && t && t[e] && (f.debug('Removing value from cache', e), delete t[e], h.data(u.cache, t))
              ...
              create: {
                ...
                id: function (e, t) {
                  ...
                  return (
                    t !== D
                      ? ((n = String.fromCharCode(97 + t) + i), f.verbose('Creating category result id', n))
              ...
              inject: {
                result: function (e, t, n) {
                  ...
                  var i =
                    n !== D
                      ? o.children().eq(n).children(g.results).first().children(g.result).eq(t)
              ...
              addResults: function (e) {
                ...
                e
                  ? (o.html(e), f.refreshResults(), c.selectFirstResult && f.select.firstResult(), f.showResults())
                  ...
                  x ||
                    (!f.is.visible() &&
                      ...
                      (f.can.transition()
                        ...
                        : (f.debug('Showing results with javascript'), o.stop().fadeIn(c.duration, c.easing)),
                ...
                (e = E.isFunction(e) ? e : function () {}),
                  f.is.visible() &&
                    (f.can.transition()
                      ...
                      : (f.debug('Hiding results with javascript'), o.stop().fadeOut(c.duration, c.easing)),
              ...
              debug: function () {
                !c.silent &&
                  ...
                  (c.performance
                    ...
                    : ((f.debug = Function.prototype.bind.call(console.info, console, c.name + ':')),
              ...
              verbose: function () {
                !c.silent &&
                  ...
                  (c.performance
                    ? f.performance.log(arguments)
                    : ((f.verbose = Function.prototype.bind.call(console.info, console, c.name + ':')),
              ...
              performance: {
                log: function (e) {
                  ...
                  c.performance &&
                    ((n = (t = new Date().getTime()) - (k || t)),
                    (k = t),
                    T.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: b, 'Execution Time': n })),
            ...
            return (
              ...
              (E.each(e[n.categoryResults], function (e, t) {
                t[n.results] !== D &&
                  ...
                  t[n.categoryName] !== D && (i += '<div class="name">' + t[n.categoryName] + '</div>'),
                  (i += '<div class="results">'),
              ...
              e[n.action] &&
                (i +=
                  '<a href="' + e[n.action][n.actionURL] + '" class="action">' + e[n.action][n.actionText] + '</a>'),
              i)
            );
          },
            ...
            (a = {
              ...
              set: {
                ...
                stageSize: function () {
                  ...
                  t.removeClass(l.active),
                    ...
                    e.remove(),
                    'auto' != r.width &&
                      (d.css('width', i + r.jitter), a.verbose('Specifying width during animation', i)),
                    'auto' != r.height &&
                      (d.css('height', o + r.jitter), a.verbose('Specifying height during animation', o));
                },
                nextSide: function (e) {
                  (g = e),
                    (o = m.filter(e)),
              ...
              stage: {
                above: function () {
                  ...
                  a.verbose('Setting the initial animation position as above', o, e),
                    ...
                    o
                      ...
                      .css({ top: e.origin + 'px', transform: 'rotateX(90deg) translateZ(' + e.depth.next + 'px)' });
                },
                below: function () {
                  var e = {
                    origin: (i.outerHeight(!0) - o.outerHeight(!0)) / 2,
                ...
                left: function () {
                  ...
                  a.verbose('Setting the initial animation position as left', o, n),
                    ...
                    o
                      .addClass(l.animating)
                      .css({ left: n.origin + 'px', transform: 'rotateY(-90deg) translateZ(' + n.depth.next + 'px)' });
                },
                right: function () {
                  var e = i.outerWidth(!0),
                    t = o.outerWidth(!0),
                ...
                behind: function () {
                  ...
                  a.verbose('Setting the initial animation position as behind', o, n),
                    ...
                    o.addClass(l.animating).css({ left: n.origin + 'px', transform: 'rotateY(-180deg)' });
                },
              },
              setting: function (e, t) {
              ...
              debug: function () {
                !r.silent &&
                  ...
                  (r.performance
                    ...
                    : ((a.debug = Function.prototype.bind.call(console.info, console, r.name + ':')),
              ...
              verbose: function () {
                !r.silent &&
                  ...
                  (r.performance
                    ? a.performance.log(arguments)
                    : ((a.verbose = Function.prototype.bind.call(console.info, console, r.name + ':')),
              ...
              performance: {
                log: function (e) {
                  ...
                  r.performance &&
                    ((n = (t = new Date().getTime()) - (x || t)),
                    (x = t),
                    C.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: p, 'Execution Time': n })),
              ...
              performance: {
                log: function (e) {
                  ...
                  u.performance &&
                    ...
                    (R = t),
                    P.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: b, 'Execution Time': n })),
                    clearTimeout(c.performance.timer),
                    (c.performance.timer = setTimeout(c.performance.display, 500));
                },
                display: function () {
            ...
            (d = {
              ...
              get: {
                direction: function (e) {
                  ...
                  return (
                    (e = e || m.scrollTop()),
                    d.lastScroll !== P && (d.lastScroll < e ? (t = 'down') : d.lastScroll > e && (t = 'up')),
                    t
                  );
                },
                ...
                containerSize: function () {
                  ...
                  'HTML' === e || 'body' == e
                    ...
                    : Math.abs(i.outerHeight() - d.cache.context.height) > f.jitter &&
                      (d.debug('Context has padding, specifying exact height for container', d.cache.context.height),
              ...
              stick: function (e) {
                ...
                0 !== a.height &&
                  ...
                  (d.is.initialPosition()
                    ...
                    ? d.is.top()
                      ? e.top <= a.top
                        ? (d.debug('Fixed element reached top of container'), d.setInitialPosition())
                        : a.height + e.top - c >= s.bottom
                      ...
                      : d.is.bottom() &&
                        (e.bottom - a.height <= a.top
                          ? (d.debug('Bottom fixed rail has reached top of container'), d.setInitialPosition())
                          : e.bottom >= s.bottom
                          ? (d.debug('Bottom fixed rail has reached bottom of container'), d.bindBottom())
                          : u && (d.set.scroll(c), d.save.lastScroll(e.top), d.save.elementScroll(c)))
                    : d.is.bottom() &&
                      (e.top <= a.top
                        ? (d.debug('Jumped from bottom fixed to top fixed, most likely used home/end button'),
                          d.setInitialPosition())
                        : f.pushing
                        ? d.is.bound() &&
                          e.bottom <= s.bottom &&
                          (d.debug('Fixing bottom attached element to bottom of browser.'), d.fixBottom())
                        : d.is.bound() &&
                          e.top <= s.bottom - a.height &&
                          (d.debug('Fixing bottom attached element to top of browser.'), d.fixTop())));
              },
              bindTop: function () {
          ...
          u.each(function () {
            ...
            (b = {
              ...
              bind: {
                events: function () {
                  E.isWindow(s) ||
                    (b.debug('Attaching tab activation events to element', k), k.on('click' + e, b.event.click));
                },
              },
              determineTabs: function () {
                ...
                'parent' === x.context
                  ...
                  : (p = E('body')),
                  x.childrenOnly
                    ? ((a = p.children(t.tabs)), b.debug('Searching tab context children for tabs', p, a))
              ...
              fix: {
                callbacks: function () {
                  E.isPlainObject(r) &&
                    ...
                    (r.onTabLoad && ((r.onLoad = r.onTabLoad), delete r.onTabLoad, b.error(S.legacyLoad, r.onLoad)),
                    r.onTabInit &&
                      ((r.onFirstLoad = r.onTabInit), delete r.onTabInit, b.error(S.legacyInit, r.onFirstLoad)),
                ...
                (d = b.utilities.arrayToPath(g)),
                  E.each(g, function (e, t) {
                    ...
                    if ((b.verbose('Looking for tab', t), l)) {
                      ...
                      if (
                        ((s = (n = E('#' + d + ', a[name="' + d + '"]')).closest('[data-tab]').data(w.tab)),
                        (u = b.get.tabElement(s)),
                        n && 0 < n.length && s)
                      )
                        return (
              ...
              update: {
                content: function (e, t, n) {
                  ...
                  (n = n !== D ? n : x.evaluateScripts),
                    'string' == typeof x.cacheType && 'dom' == x.cacheType.toLowerCase() && 'string' != typeof t
                  ...
                  (n = n || t),
                    ...
                    x.cache && i
                      ? (b.activate.tab(t),
                        ...
                        x.loadOnce ||
                          ('once' == x.evaluateScripts ? b.update.content(t, i, !1) : b.update.content(t, i)),
                        x.onLoad.call(o[0], t, v, y))
                      : s
              ...
              debug: function () {
                !x.silent &&
                  ...
                  (x.performance
                    ...
                    : ((b.debug = Function.prototype.bind.call(console.info, console, x.name + ':')),
              ...
              verbose: function () {
                !x.silent &&
                  ...
                  (x.performance
                    ? b.performance.log(arguments)
                    : ((b.verbose = Function.prototype.bind.call(console.info, console, x.name + ':')),
              ...
              performance: {
                log: function (e) {
                  ...
                  x.performance &&
                    ((n = (t = new Date().getTime()) - (f || t)),
                    (f = t),
                    m.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: s, 'Execution Time': n })),
            ...
            (f = {
                  ...
                  if (u.queue)
                    return (
                      !u.allowRepeats && f.has.direction() && f.is.occurring() && !0 !== f.queuing
                        ? f.debug('Animation is currently occurring, preventing queueing same animation', u.animation)
                        : f.queue(u.animation),
                      !1
                    );
                  if (!u.allowRepeats && f.is.occurring())
                    return (
                      f.debug('Animation is already occurring, will not execute repeated animation', u.animation), !1
                    );
              ...
              complete: function (e) {
                f.debug('Animation complete', u.animation),
                  ...
                  f.is.looping() ||
                    (f.is.outward()
                      ? (f.verbose('Animation is outward, hiding element'), f.restore.conditions(), f.hide())
                      : f.is.inward()
                      ? (f.verbose('Animation is outward, showing element'), f.restore.conditions(), f.show())
                      : (f.verbose('Static animation completed'), f.restore.conditions(), u.onComplete.call(l)));
              },
              force: {
                visible: function () {
                  var e = m.attr('style'),
                    ...
                    a = e === S || '' === e;
                  o !== n
                    ? (f.verbose('Overriding default display to show element', n), m.attr('style', i))
                ...
                hidden: function () {
                  ...
                  'none' === t || f.is.hidden()
                    ...
                    : (f.verbose('Overriding default display to hide element'), m.css('display', 'none'));
                },
              },
              has: {
                direction: function (e) {
              ...
              get: {
                settings: function (e, t, n) {
                  return 'object' == typeof e
                    ...
                    : 'function' == typeof n
                    ? C.extend({}, C.fn.transition.settings, { animation: e, onComplete: n, duration: t })
                ...
                displayType: function (e) {
                  return (
                    ...
                    u.displayType
                      ? u.displayType
                      : (e && m.data(n.displayType) === S && f.can.transition(!0), m.data(n.displayType))
                  );
                },
              ...
              debug: function () {
                !u.silent &&
                  ...
                  (u.performance
                    ? f.performance.log(arguments)
                    : ((f.debug = Function.prototype.bind.call(console.info, console, u.name + ':')),
                      f.debug.apply(console, arguments)));
              },
              verbose: function () {
                !u.silent &&
                  ...
                  (u.performance
                    ? f.performance.log(arguments)
                    : ((f.verbose = Function.prototype.bind.call(console.info, console, u.name + ':')),
                      f.verbose.apply(console, arguments)));
              },
              error: function () {
                u.silent ||
              ...
              performance: {
                log: function (e) {
                  ...
                  u.performance &&
                    ((n = (t = new Date().getTime()) - (p || t)),
                    (p = t),
                    h.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: l, 'Execution Time': n })),
                    clearTimeout(f.performance.timer),
                    (f.performance.timer = setTimeout(f.performance.display, 500));
                },
                display: function () {
            ...
            (l = {
              ...
              read: {
                cachedResponse: function (e) {
                  ...
                  if (E.Storage !== F)
                    return (
                      (t = sessionStorage.getItem(e)), l.debug('Using cached response', e, t), (t = l.decode.json(t))
                    );
                  l.error(u.noStorage);
                },
              },
              ...
              add: {
                ...
                formData: function (e) {
                  ...
                  return (
                    ...
                    (e = P.isPlainObject(e)
                      ? t
                        ? (l.debug('Extending existing data with form data', e, n), P.extend(!0, {}, e, n))
              ...
              event: {
                  ...
                  always: function () {},
                    ...
                    var i = this,
                      ...
                      r =
                        ...
                        (l.is.expectingJSON() ? c.onResponse.call(i, P.extend(!0, {}, e)) : c.onResponse.call(i, e));
                    (a = 0 < a ? a : 0),
                ...
                request: {
                    ...
                    l.debug('Successful API Response', e),
                      'local' === c.cache &&
                        n &&
                        (l.write.cachedResponse(n, e), l.debug('Saving server response locally', l.cache)),
                  ...
                  fail: function (e, t, n) {
                    ...
                    if ('aborted' == t)
                      return (
                        l.debug('XHR Aborted (Most likely caused by page navigation or CORS Policy)', t, n),
                        c.onAbort.call(b, t, g, e),
                        !0
                      );
                    'invalid' == t
                      ? l.debug('JSON did not pass success test. A server-side error has most likely occurred', i)
                      : 'error' == t &&
                        e !== F &&
              ...
              create: {
                ...
                mockedXHR: function () {
                  ...
                  return (
                    (n = P.Deferred().always(l.event.xhr.complete).done(l.event.xhr.done).fail(l.event.xhr.fail)),
                    i
                      ? ((t = P.isFunction(i)
                ...
                xhr: function () {
                  var e;
                  return (
                    (e = P.ajax(a).always(l.event.xhr.always).done(l.event.xhr.done).fail(l.event.xhr.fail)),
              ...
              get: {
                responseFromXHR: function (e) {
                  return (
                    !!P.isPlainObject(e) && (l.is.expectingJSON() ? l.decode.json(e.responseText) : e.responseText)
                  );
                },
              ...
              performance: {
                log: function (e) {
                  ...
                  c.performance &&
                    ...
                    (S = t),
                    k.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', 'Execution Time': n })),
                    clearTimeout(l.performance.timer),
                    (l.performance.timer = setTimeout(l.performance.display, 500));
                },
                display: function () {
            ...
            (s = {
              ...
              set: {
                fixed: function () {
                  s.verbose('Setting element to fixed position'),
                    f
                      .addClass(i.fixed)
                      .css({ position: 'fixed', top: o.offset + 'px', left: 'auto', zIndex: o.zIndex }),
                    o.onFixed.call(h);
                },
                image: function (e, t) {
              ...
              passingReverse: function (e) {
                var t = s.get.elementCalculations(),
                  ...
                  i = 'passingReverse';
                if (
                  (e && (s.debug('Adding callback for passing reverse', e), (o.onPassingReverse = e)),
                  t.passing ? o.once || s.remove.occurred(i) : s.get.occurred('passing') && s.execute(n, i),
                  e !== O)
                )
                  return !t.passing;
              },
              topVisibleReverse: function (e) {
                var t = s.get.elementCalculations(),
                  ...
                  i = 'topVisibleReverse';
                if (
                  (e && (s.debug('Adding callback for top visible reverse', e), (o.onTopVisibleReverse = e)),
                  t.topVisible ? o.once || s.remove.occurred(i) : s.get.occurred('topVisible') && s.execute(n, i),
                  e === O)
                )
                  return !t.topVisible;
              },
              bottomVisibleReverse: function (e) {
                ...
                if (
                  (e && (s.debug('Adding callback for bottom visible reverse', e), (o.onBottomVisibleReverse = e)),
                  t.bottomVisible ? o.once || s.remove.occurred(i) : s.get.occurred('bottomVisible') && s.execute(n, i),
                  e === O)
                )
                  return !t.bottomVisible;
              },
              topPassedReverse: function (e) {
                var t = s.get.elementCalculations(),
                  ...
                  i = 'topPassedReverse';
                if (
                  (e && (s.debug('Adding callback for top passed reverse', e), (o.onTopPassedReverse = e)),
                  t.topPassed ? o.once || s.remove.occurred(i) : s.get.occurred('topPassed') && s.execute(n, i),
                  e === O)
                )
              ...
              bottomPassedReverse: function (e) {
                ...
                if (
                  (e && (s.debug('Adding callback for bottom passed reverse', e), (o.onBottomPassedReverse = e)),
                  t.bottomPassed ? o.once || s.remove.occurred(i) : s.get.occurred('bottomPassed') && s.execute(n, i),
                  e === O)
                )
                  return !t.bottomPassed;
              },
              ...
              save: {
                ...
                direction: function () {
                  var e,
                    ...
                    n = s.get.lastScroll();
                  return (
                    (e = n < t && n ? 'down' : t < n && n ? 'up' : 'static'), (s.cache.direction = e), s.cache.direction
                  );
                },
                elementPosition: function () {
                  ...
                  return (
                    ...
                    s.is.verticallyScrollableContext() && (e.offset.top += m.scrollTop() - m.offset().top),
                    s.is.horizontallyScrollableContext() && (e.offset.left += m.scrollLeft - m.offset().left),
                    (s.cache.element = e)
                  );
                },
              ...
              debug: function () {
                !o.silent &&
                  ...
                  (o.performance
                    ? s.performance.log(arguments)
                    : ((s.debug = Function.prototype.bind.call(console.info, console, o.name + ':')),
                      s.debug.apply(console, arguments)));
              },
              verbose: function () {
                !o.silent &&
                  ...
                  (o.performance
                    ? s.performance.log(arguments)
                    : ((s.verbose = Function.prototype.bind.call(console.info, console, o.name + ':')),
                      s.verbose.apply(console, arguments)));
              },
              error: function () {
                o.silent ||
              ...
              performance: {
                log: function (e) {
                  ...
                  o.performance &&
                    ...
                    (C = t),
                    w.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: h, 'Execution Time': n })),
                    clearTimeout(s.performance.timer),
                    (s.performance.timer = setTimeout(s.performance.display, 500));
                },
                display: function () {

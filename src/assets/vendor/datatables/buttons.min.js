...
(function (d) {
      ...
      var c = [],
        ...
        g = function (a, b) {
          ...
          if (d.isArray(a) || a instanceof d) for (k = 0, f = a.length; k < f; k++) g(a[k], b);
            ...
            for (k = 0, f = h.length; k < f; k++) c.push({ inst: b, node: h[k].node });
            ...
            if (-1 !== a.indexOf(',')) for (h = a.split(','), k = 0, f = h.length; k < f; k++) g(d.trim(h[k]), b);
              ...
              for (a = a.replace(':name', ''), k = 0, f = h.length; k < f; k++)
                h[k].name === a && c.push({ inst: b, node: h[k].node });
            else
              d(k)
                .filter(a)
                .each(function () {
            ...
            'object' === typeof a && a.nodeName && ((h = d.inArray(a, k)), -1 !== h && c.push({ inst: b, node: k[h] }));
        },
        f = 0,
        h = a.length;
      f < h;
  ...
  m.Api.register('buttons.exportInfo()', function (a) {
    ...
    var b = a;
    var c =
      '*' === b.filename && '*' !== b.title && b.title !== p && null !== b.title && '' !== b.title
        ? b.title
        : b.filename;

(function (i) {
      ...
      if (i.isPlainObject(b)) {
        ...
        if (s) {
          ...
          for (f = e.attributes.length - 1; 0 <= f; f--) {
            ...
            -1 !== h.indexOf(':') && (m.push({ name: h, value: g }), e.removeAttribute(h));
          }
          f = 0;
          for (h = m.length; f < h; f++)
            (g = b.createAttribute(m[f].name.replace(':', '_dt_b_namespace_token_'))),
              (g.value = m[f].value),
              e.setAttributeNode(g);
        }
        e = v.serializeToString(b);
        s &&
          (-1 === e.indexOf('<?xml') && (e = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + e),
  ...
  if ('undefined' === typeof h || ('undefined' !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)))
    o = void 0;
  else {
      ...
      D = function (a, c, d) {
        ...
        if (J)
          ...
          e || (e = (h.URL || h.webkitURL || h).createObjectURL(a)),
            d ? (h.location.href = e) : h.open(e, '_blank') || (h.location.href = e),
            (b.readyState = b.DONE),
            f(),
            B(e);
      },
        ...
        var d = E(c),
          ...
          h = function (a) {
            for (var b = '', c = 0, d = a.length; c < d; c++)
              0 < c && (b += f), (b += e ? e + ('' + a[c]).replace(i, m + e) + e : a[c]);
            return b;
          },
  ...
  l.ext.buttons.excelHtml5 = {
    ...
    action: function (a, c, d, b) {
      var e = 0,
        ...
        d = function (a) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            for (var d = b, g = ''; 0 <= d; )
              (g = String.fromCharCode((d % 26) + 65) + g), (d = Math.floor(d / 26) - 1);
            var d = g + '' + m,
              j = null;
            if (!(null === a[b] || a[b] === p || '' === a[b])) {
              ...
              for (var l = 0, o = H.length; l < o; l++)
                if (((g = H[l]), a[b].match && a[b].match(g.match))) {
                  j = a[b].replace(/[^\d\.\-]/g, '');
                  g.fmt && (j = g.fmt(j));
                  j = n(f, 'c', { attr: { r: d, s: g.style }, children: [n(f, 'v', { text: j })] });
                  break;
                }
              j ||
                ('number' === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                  ? (j = n(f, 'c', { attr: { t: 'n', r: d }, children: [n(f, 'v', { text: a[b] })] }))
                  : ((g = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '')),
                    (j = n(f, 'c', {
                      attr: { t: 'inlineStr', r: d },
                      children: { row: n(f, 'is', { children: { row: n(f, 't', { text: g }) } }) },
                    }))));
              k.appendChild(j);
            }
          }
      ...
      for (l = c.header.length; j < l; j++)
        d.appendChild(n(f, 'col', { attr: { min: j + 1, max: j + 1, width: I(c, j), customWidth: 1 } }));

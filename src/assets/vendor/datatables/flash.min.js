(function (g) {
  'function' === typeof define && define.amd
    ? define(['jquery', 'datatables.net', 'datatables.net-buttons'], function (k) {
        return g(k, window, document);
      })
    : 'object' === typeof exports
    ? (module.exports = function (k, l) {
        k || (k = window);
      ...
      if (g.isPlainObject(d)) v(d);
        ...
        if (n) {
          ...
          for (e = c.attributes.length - 1; 0 <= e; e--) {
            ...
            -1 !== f.indexOf(':') && (h.push({ name: f, value: q }), c.removeAttribute(f));
          }
          e = 0;
  ...
  h.Client.prototype = {
    ...
    positionElement: function () {
      ...
      0 !== a.width &&
        0 !== a.height &&
        ((this.sized = !0), (b = this.div.childNodes[0]), (b.width = a.width), (b.height = a.height));
    },
      ...
      switch (a) {
        ...
        case 'mouseout':
          this.domElement &&
            ...
            this.domElement.hasClass('active') && (this.domElement.removeClass('active'), (this.recoverActive = !0)));
          break;
        case 'mousedown':
  ...
  var x = function (a, b) {
    ...
    y = function (a, b) {
      for (
        var d = b.newline ? b.newline : navigator.userAgent.match(/Windows/) ? '\r\n' : '\n',
          ...
          l = b.header ? k(c.header) + d : '',
          j = b.footer && c.footer ? d + k(c.footer) : '',
          m = [],
          u = 0,
          C = c.body.length;
        u < C;
        ...
        m.push(k(c.body[u]));
      return { str: l + m.join(d) + j, rows: m.length };
    },
    t = {
      available: function () {
        return h.hasFlash();
  ...
  i.ext.buttons.copyFlash = g.extend({}, t, {
    ...
    action: function (a, b, d, c) {
      c._fromFlash &&
        ...
        b.buttons.info(
          ...
          b.i18n('buttons.copySuccess', { _: 'Copied %d rows to clipboard', 1: 'Copied 1 row to clipboard' }, d.rows),
          3e3
        ));
    },
    fieldSeparator: '\t',
  ...
  i.ext.buttons.csvFlash = g.extend({}, t, {
  ...
  i.ext.buttons.excelFlash = g.extend({}, t, {
    ...
    action: function (a, b, d, c) {
      var a = c._flash,
        ...
        d = {
          ...
          xl: {
            _rels: { 'workbook.xml.rels': g.parseXML(o['xl/_rels/workbook.xml.rels']) },
        ...
        i = function (a) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            for (var d = b, i = ''; 0 <= d; )
              (i = String.fromCharCode((d % 26) + 65) + i), (d = Math.floor(d / 26) - 1);
            var d = i + '' + k,
              j = null;
            if (!(null === a[b] || a[b] === p || '' === a[b])) {
              a[b] = g.trim(a[b]);
              for (var n = 0, o = z.length; n < o; n++)
                if (((i = z[n]), a[b].match && a[b].match(i.match))) {
                  j = a[b].replace(/[^\d\.\-]/g, '');
                  i.fmt && (j = i.fmt(j));
                  j = m(f, 'c', { attr: { r: d, s: i.style }, children: [m(f, 'v', { text: j })] });
                  break;
                }
              j ||
                ('number' === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                  ? (j = m(f, 'c', { attr: { t: 'n', r: d }, children: [m(f, 'v', { text: a[b] })] }))
                  : ((i = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '')),
                    (j = m(f, 'c', {
                      attr: { t: 'inlineStr', r: d },
                      children: { row: m(f, 'is', { children: { row: m(f, 't', { text: i }) } }) },
                    }))));
              l.appendChild(j);
            }
          }
      ...
      g('sheets sheet', d.xl['workbook.xml']).attr('name', B(c));
      c.customizeData && c.customizeData(b);
      c.header && (i(b.header, e), g('row c', f).attr('s', '2'));
      for (var j = 0, n = b.body.length; j < n; j++) i(b.body[j], e);
      c.footer && b.footer && (i(b.footer, e), g('row:last c', f).attr('s', '2'));
      i = m(f, 'cols');
      g('worksheet', f).prepend(i);
      j = 0;
      for (n = b.header.length; j < n; j++)
        i.appendChild(m(f, 'col', { attr: { min: j + 1, max: j + 1, width: A(b, j), customWidth: 1 } }));

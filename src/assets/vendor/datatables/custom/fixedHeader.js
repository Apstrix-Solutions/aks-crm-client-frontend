  ...
  d.extend(i.prototype, {
    ...
    _clone: function (b, a) {
      ...
      !a && c.floating
        ...
        : (c.floating && (c.placeholder.remove(), this._unsize(b), c.floating.children().detach(), c.floating.remove()),
    ...
    _positions: function () {
      ...
      f.length
        ...
        : ((a.tfootTop = a.tbodyTop + e.outerHeight()), (a.tfootBottom = a.tfootTop), (a.tfootHeight = a.tfootTop));
    },
    _scroll: function (b) {
      var a = d(h).scrollTop(),
        e = d(h).scrollLeft(),
      ...
      if (
        ...
        (a =
          !c.visible || a + c.windowHeight >= c.tfootBottom + this.c.footerOffset
            ? 'in-place'
            : c.windowHeight + a > c.tbodyTop + c.tfootHeight + this.c.footerOffset
            ? 'in'
            : 'above'),

    ...
    slimScroll: function (f) {
      ...
      this.each(function () {
        ...
        function n(d, g, e) {
          ...
          g &&
            ((g = parseInt(c.css('top')) + ((d * parseInt(a.wheelStep)) / 100) * c.outerHeight()),
        ...
        function w() {
          ...
          clearTimeout(B);
          l == ~~l
            ? ((k = a.allowPageScroll), C != l && b.trigger('slimscroll', 0 == ~~l ? 'top' : 'bottom'))
            : (k = !1);
          C = l;
          u >= b.outerHeight()
            ? (k = !0)
            : (c.stop(!0, !0).fadeIn('fast'), a.railVisible && m.stop(!0, !0).fadeIn('fast'));
        }
        function p() {
          a.alwaysVisible ||
        ...
        if (b.parent().hasClass(a.wrapperClass)) {
          ...
          b.bind('touchmove', function (b) {
            ...
            b.originalEvent.touches.length &&
              (n((A - b.originalEvent.touches[0].pageY) / a.touchScrollStep, !0),
              (A = b.originalEvent.touches[0].pageY));
          });
          x();
          'bottom' === a.start
            ? (c.css({ top: b.outerHeight() - c.outerHeight() }), n(0, !0))
            : 'top' !== a.start && (n(e(a.start).position().top, null, !0), a.alwaysVisible || c.hide());
          window.addEventListener
            ? (this.addEventListener('DOMMouseScroll', v, !1), this.addEventListener('mousewheel', v, !1))
